...
Выполняет Seq1 если expr истинно иначе выполняет Seq2
...
Первое читает число и связывает его с name, второе пишет результат expr
